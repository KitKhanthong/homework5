...
import 'package:homework5/pages/project/project_details_page.dart';
...
class _ProjectListPageState extends State<ProjectListPage> {
  List<Project> projects = [
    Project(
      ...
      receiveAmount: 10000,
      donateCount: 13,
      imageUrl: 'https://taejai.com/media/projects/107925950557865513466971890391231979223.jpg.640x380_q85_crop_upscale.jpg',
    ),
    Project(
